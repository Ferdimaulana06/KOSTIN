            ...
            <div class=" flex flex-col md:flex-col lg:flex-row items-start md:items-center gap-8">
                ...
                <div class="w-full flex flex-col text-left">
                    ...
                    <div class="lg:hidden order-2 mb-8">
                        <img src="../assets/img/tentang/tentang.png" alt="Layanan Pencari Kos"
                            class="rounded-md w-full h-auto" />
                    </div>

                    <!-- Deskripsi -->
                    <div class="space-y-8 text-gray-800 order-3">
                        <p class="leading-8">KOSTIN adalah platform pencarian kos dan properti
                            <br> sewa yang menghubungkan pencari
                            hunian dengan <br>
                            pemilik properti secara langsung. <br>
                        </p>
    ...
    <section
        ...
        <div
            ...
            <div
                ...
                <!-- Gambar untuk versi desktop -->
                <div
                    class="hidden lg:flex md:hidden h-[440px] w-[300px] bg-[url(../assets/img/tentang/card-tentang.png)] bg-cover bg-center rounded-xl">
                </div>
                <!-- Konten Teks -->
