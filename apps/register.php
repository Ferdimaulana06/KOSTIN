...
<body>
  <div class="container">
    ...
    <form id="registerForm" action="proses.php" method="POST">
      ...
      <div class="input-group">
        <input id="password" name="password" type="password" class="" placeholder="Password (minimal 8 karakter)"
          required />
      </div>
      <div class="input-group">
        <input id="passwordvalidasi" type="password" class="" placeholder="Ulangi Password" required />
      </div>
      <button type="submit" class="daftar-btn">Daftar</button>
    </form>
    <p class="haveacc-text">
      <a href="../apps/login.php">Sudah punya akun</a>
    </p>
  </div>
